...
class FMNIST_Dataset(BaseADDataset):
    def __init__(self, root: str, normal_class=0, contam_ratio=0,random_seed=0):
        super().__init__(root)
        ...
        self.train_set = MyFMNIST(trainx, trainy, transform=transform, target_transform=target_transform)
        self.val_set = MyFMNIST(validx, validy, transform=transform, target_transform=target_transform)
        self.test_set = MyFMNIST(testx, testy, transform=transform, target_transform=target_transform)
...
def get_train(label=-1, centered=True, normalize=True,contam_ratio=0,random_seed=0):
    return _get_adapted_dataset("train", label, centered, normalize,contam_ratio)

def get_test(label=-1, centered=True, normalize=True,contam_ratio=0,random_seed=0):
    return _get_adapted_dataset("test", label, centered, normalize,contam_ratio)

def get_valid(label=-1, centered=True, normalize=True,contam_ratio=0,random_seed=0):
    return _get_adapted_dataset("valid", label, centered, normalize,contam_ratio)
